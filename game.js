...
function update() {
    ...
    */
    ...
    if (this.hero.health <= 0) {
        ...
        let tmp_booster_choice = Math.random() * 100;
        if (booster_timer == 370 && this.boosters.length < 10) {
            ...
            while (true) {
                if (layerBackground2.getTileAt(boosterX, boosterY) != null) {
                    if (layerBackground2.getTileAt(boosterX, boosterY).layer.name == "bg2") {
                        ...
                        } else if (tmp_booster_choice >= 36 && tmp_booster_choice < 70) {
